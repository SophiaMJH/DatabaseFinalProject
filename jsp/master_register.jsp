...
<div id="content" align="center">
	<form id="update_form" action="master_insert.jsp" onsubmit="return check()" method="post">
       	<table>
       		<tr><td></td>
			<tr><td bgcolor="rgb(13,45,132)" height="500" width="100"align="center"><font color="white">교수명</font></td>
			<td><input type="text" name="p_name" height="50" width="500 "/></tr>
			<tr><td bgcolor="rgb(13,45,132)" height="50" width="100"align="center"><font color="white">과목명</font></td>
			<td><input type="text" name="c_name height="50" width="500 " /></td></tr>
